...
<div class="main-container shop-page dokan-store-item">
    <div class="container">
        ...
        <div class="row">
            <div class="main-content col-sm-12">
                <div class="main-product">
				    ...
				    <?php } ?>
                    <div id="dokan-primary" class="dokan-single-store <?php if ( dokan_get_option( 'enable_theme_store_sidebar', 'dokan_appearance', 'off' ) == 'off' ) { ?>dokan-w8<?php }?>">
