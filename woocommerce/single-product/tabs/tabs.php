...
$enable_single_product_mobile = lebe_get_option( 'enable_single_product_mobile', false );
...
if( ($enable_single_product_mobile == 1) && (lebe_is_mobile())){ ?>
...
<?php }elseif($product_style == 'sticky_detail') {?>
